...
@section('title_text', 'Role Update')
@section('page_title', 'Update Role')
@section('content')
            ...
            <div class="col-12">
                <div class="crancy-body">
                    ...
                    <div class="crancy-dsinner">
                        <form action="{{ route('adminteam.roleUpdate', $role->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="crancy__item-form--group mt-2">
                                                    ...
                                                    <input class="form-control" type="text" name="display_name"
                                                        id="display_name" value="{{ old('display_name', $role->display_name) }}">
                                                </div>
                                            </div>
                                                    ...
                                                    <ul class="list-unstyled mb-0" id="permissionGroups">
                                                        ...
                                                        <li class="border rounded mb-3">
                                                            ...
                                                            <div class="bg-light p-3 border-bottom">
                                                                <div class="form-check">
                                                                    <input type="checkbox" {{ in_array($group->id, $existingPermissions) ? 'checked' : '' }}
                                                            ...
                                                            <div class="p-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3 col-sm-6 mb-2">
                                                                        <div class="form-check">
                                                                            <input type="checkbox" {{ in_array($child->id, $existingPermissions) ? 'checked' : '' }}
