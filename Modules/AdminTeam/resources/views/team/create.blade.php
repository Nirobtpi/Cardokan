...
@section('title_text', 'Team Create')
    ...
    <div class="row">
        ...
        <div class="col-md-8 offset-2">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('adminteam.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="brand_name" class="form-label">Name *</label>
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" id="brand_name">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="checkbox" data-toggle="toggle" name="status" value="1" data-on="Enabled" data-off="Disabled">
                        </div>
                        <div class="mb-3">
