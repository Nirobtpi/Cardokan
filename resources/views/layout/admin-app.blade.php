...
<head>
    ...
    <title>CarDokan | @yield('title_text')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=yes">
    <meta name="color-scheme" content="light dark">
    <meta name="theme-color" content="#007bff" media="(prefers-color-scheme: light)">
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)">

    <meta name="title" content="CarDokan | @yield('title_text')">
    ...
    <div class="app-wrapper">
        ...
        <nav class="app-header navbar navbar-expand bg-body">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" data-bs-toggle="dropdown" href="#"> <i class="bi bi-bell-fill"></i> <span
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link"> <i class="nav-icon bi bi-box-seam-fill"></i>
                                <p>Manage Car <i class="nav-arrow bi bi-chevron-right"></i> </p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./widgets/small-box.html" class="nav-link"> <i
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link"> <i class="bi bi-envelope"></i>
                                <p>Email Configuration<i class="nav-arrow bi bi-chevron-right"></i> </p>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.logout') }}" class="nav-link"> <i class="bi bi-box-arrow-left"></i>
                                <p>Log Out</p>
                            </a>
                        </li>
                    </ul>
        ...
        <footer class="app-footer">
            ...
            <!--begin::Copyright--><strong>
                ...
                <a href="" class="text-decoration-none">CarDoakn</a>.
