                    ...
                    <form action="{{ route('car.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            <div class="row">
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <select class="form-select" id="brands" name="brand">
                                        <option selected="" value="">Choose...</option>
                        ...
                        <div class="form-group mb-5">
                            ...
                            <textarea class="form-control" name="description" id="description"
                                aria-label="With textarea" style="height: 170px;"></textarea>
                        </div>
                            ...
                            <div class="col-lg-12">
                                @foreach ($features as $feature)
                                    <div class="form-check d-inline-block me-3 mb-2"> 
                                        <input class="form-check-input" type="checkbox" value="{{ $feature->id }}" name="feature[]" id="{{ $feature->name }}">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#title').on('keyup',function(){
                let val=$(this).val();
                let slug= val.toLowerCase().toLowerCase().replace(/\s+/g, '-').replace(/--+/g, '-').replace(/^-+|-+$/g, '');
                $('#slug').val(slug);
            });
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        $.each(response, function(index,city){
                             html.append(`<option value="${city.id}">${city.name}</option>`);
                        })
                    }
                });
            })
