                ...
                <div class="card-body">
                    <form action="{{ route('brand.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="slug" value="{{ $brand->brand_slug }}" class="form-control" id="slug">
                             <div class="invalid-feedback">
                                @error('slug')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="mt-2">
                                <img id="blah" src="{{ asset($brand->brand_logo) }}" width="100" height="100" />
                            </div>
                            <div class="invalid-feedback">
                                @error('photo')
                                    {{ $message }}
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="checkbox" {{ $brand->status == 1 ? 'checked' : '' }} data-toggle="toggle" name="visibility" value="1" data-on="Enabled" data-off="Disabled">
                        </div>
                        <div class="mb-3">
