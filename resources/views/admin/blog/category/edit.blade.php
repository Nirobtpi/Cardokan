                ...
                <div class="card-body">
                    <form action="{{ route('blog-category.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" value="{{ old('slug', $category->slug) }}" name="slug" class="form-control" id="slug">
                            @error('slug')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" {{ $category->status == 'on' ? 'checked' : '' }} name="status" type="checkbox" role="switch" id="status">
                        </div>
                        <div class="from-grop">
