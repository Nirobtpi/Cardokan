...
@section('title_text', 'Country List')
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('country.create') }}" class="btn btn-primary">+ Country Create</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <table id="country_table" class="table table-bordered" role="table">
                    <thead>
                        <tr>
